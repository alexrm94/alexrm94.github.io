...
function chinese() {
    farm.style.fontFamily = "Chinese";
    product.style.fontFamily = "Chinese";
    video.style.fontFamily = "Chinese";
    team.style.fontFamily = "Chinese";
    contact.style.fontFamily = "Chinese";
    nav1.style.fontFamily = "Chinese";
    nav2.style.fontFamily = "Chinese";
    ...
    video.innerHTML = "观看我们的内容";
    team.innerHTML = "了解我们的团队";
    contact.innerHTML = "联系信息";
    nav1.innerHTML = "农场";
    nav2.innerHTML = "菠萝";
    nav3.innerHTML = "影片";
    nav4.innerHTML = "团队";
...
function khmer() {
    ...
    const element = document.getElementById("farm");
    document.getElementById("farm").style.fontFamily = "khmer";
    document.getElementById("product").style.fontFamily = "khmer";
    document.getElementById("video").style.fontFamily = "khmer";
    document.getElementById("team").style.fontFamily = "khmer";
    document.getElementById("contact").style.fontFamily = "khmer";
    element.innerHTML = "ស្គាល់កសិដ្ឋានរបស់យើង។";


    farm.style.fontFamily = "khmer";
    product.style.fontFamily = "khmer";
    video.style.fontFamily = "khmer";
    team.style.fontFamily = "khmer";
    contact.style.fontFamily = "khmer";
    nav1.style.fontFamily = "khmer";
    nav2.style.fontFamily = "khmer";
    ...
    video.innerHTML = "មើលមាតិការបស់យើង។";
    team.innerHTML = "ស្គាល់ក្រុមរបស់យើង។";
    contact.innerHTML = "ព័ត៌មានទំនាក់ទំនង";
    nav1.innerHTML = "កសិដ្ឋាន";
    nav2.innerHTML = "ម្នាស់";
